...
geo_outbreaks_wide <- final_outbreaks |>
  count(Country, iso3, icd104c, 
        Continent, Longitude, Latitude) |>
  pivot_wider(
    id_cols = c("Country", "iso3", "Continent", 
                "Longitude", "Latitude"),
    names_from = icd104c,
    values_from = n,
    values_fill = 0
...
fig4a_reproduced <- geo_outbreaks_wide  |> 
  ...
  ggplot(aes(x = fct_reorder(Country, -Freq), 
             y = Freq, 
             fill = Continent)) +
...
fig4a_reproduced
ggsave(fig3_reproduced, filename = "/net/pupil1/home/people/s222777/projects/group_12_project_/Results/fig3_reproduced.png", dpi = 300)
```
...
fig3_reproduced
ggsave(fig4a_reproduced, filename = "/net/pupil1/home/people/s222777/projects/group_12_project_/Results/fig4a_reproduced.png", dpi = 300)
```
...
ggsave(fig4c_reproduced, filename = "/net/pupil1/home/people/s222777/projects/group_12_project_/Results/fig4c_reproduced.png", dpi = 300)
