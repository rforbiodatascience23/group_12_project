...
We keep only the variables needed, and rename Country.Code to iso3 for merging purposes. 
Renaming Kosovo ISO3 code, as it does not have a universally accepted code, and therefor differs between the world bank and the WHO. 
We filter to include only countries with income data available.
