...
![Fig. 4b Top 20 disease-outbreaks(Reproduced)](../Results/Fig4b_reproduced.png) {.absolute bottom="500" right="200" width="100"}
![Fig. 4b Top 20 disease-outbreaks colored by country income status (Novel)](../Results/Fig4b_income.png){.absolute bottom="500" right="600" width="300"}
