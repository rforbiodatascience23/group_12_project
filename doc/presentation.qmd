...
![](Disease_type_distribution.jpg){.absolute top="100" left="30" width="300" height="200"}
...
<div style="display: flex; justify-content: space-between;">
  <img src="../Results/Fig4b_reproduced.png" alt="Fig. 4b Top 20 disease-outbreaks(Reproduced)" width="45%">
  <img src="../Results/Fig4b_income.png" alt="Fig. 4b Top 20 disease-outbreaks colored by country income status (Novel)" width="45%">
</div>
...
<div style="display: flex; justify-content: space-between;">
  <img src="../Results/fig4a_reproduced.png" alt="Top 20 Countries with highest Outbreak Frequency" width="45%">
  <img src="../Results/fig3_reproduced.png" alt="Outbreak Frequency Map Graph" width="45%">
</div>
