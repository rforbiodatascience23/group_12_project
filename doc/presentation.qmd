...
![](article.png){fig-align="center" width="100%"}

\<\<\<\<\<\<\< HEAD - **Their aim** was to create a new dataset of infectious disease outbreaks from the Disease Outbreak News and Coronavirus Dashboard (WHO)
